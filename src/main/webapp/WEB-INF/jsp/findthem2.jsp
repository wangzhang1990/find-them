...
.menu-toggle, button, .ast-button, .button, input#submit, input[type="button"],
...
<link rel="icon"
	href="https://wp-becto-1258614189.cos.ap-chengdu.myqcloud.com/wp-content/uploads/2019/02/logoko-150x150.jpg"
	sizes="32x32" />
<link rel="icon"
	href="https://wp-becto-1258614189.cos.ap-chengdu.myqcloud.com/wp-content/uploads/2019/02/logoko.jpg"
	sizes="192x192" />
<link rel="apple-touch-icon-precomposed"
	href="https://wp-becto-1258614189.cos.ap-chengdu.myqcloud.com/wp-content/uploads/2019/02/logoko.jpg" />
<meta name="msapplication-TileImage"
	content="https://wp-becto-1258614189.cos.ap-chengdu.myqcloud.com/wp-content/uploads/2019/02/logoko.jpg" />
</head>

<body itemtype='https://schema.org/Blog' itemscope='itemscope'
	class="archive category category-wordpress category-15 ast-desktop ast-separate-container ast-two-container ast-right-sidebar astra-1.6.8 ast-header-custom-item-inside ast-inherit-site-logo-transparent">
						...
						<div class="ast-flex main-header-container">
							...
							<div class="ast-mobile-menu-buttons">
								...
								<div class="ast-button-wrap">
									<button type="button"
										...
										rel="main-menu" aria-controls='primary-menu'
										aria-expanded='false'>
										<span class="screen-reader-text">主菜单</span> <span
							...
							<div class="main-header-bar-navigation">
								<nav itemtype="https://schema.org/SiteNavigationElement"
									itemscope="itemscope" id="site-navigation"
									class="ast-flex-grow-1" role="navigation"
			...
			<div class="ast-container">
				...
				<div id="primary" class="content-area primary">
					...
					<section class="ast-archive-description">
						<h5>这里抓取了该回答下上万条记录，并且每小时更新一次最新数据。</h5>
						<h5>看看你能否在茫茫人海找那个，找到那个你想要找到的人</h5>
						<hr>
						<form method="get" action="find">
							<input type="hidden" name="page" value="1"> <input
								type="search" placeholder="搜索..." name="keyword"
								value="${ keyword }" onfocus="keywordInit()"
								style="height: 50px;" /> <input type="submit" value="搜索TA" />
							(比如按城市搜索)
						</form>

						<div>
							<hr>
							<span>当前第${ page }页=======>>></span> <a href="javascript:void(0)"
								onclick="previousPage()">上一页</a> <<==>> <a
								href="javascript:void(0)" onclick="nextPage()">下一页</a>=======>>>
							第 <input type="text" name="page_located" value="${ page }"
								style="width: 80px">页 <a href="javascript:void(0)"
								onclick="locatePage()">跳转</a> <br>
							<hr>
						</div>
					</section>
					...
					<div class="ast-row">
						...
						<c:forEach items="${ result.data }" var="answer">
							<article itemtype="https://schema.org/CreativeWork"
								itemscope="itemscope" id="post-545"
								class="post-545 post type-post status-publish format-standard hentry category-wordpress ast-col-sm-12 ast-article-post">
									...
									<div class="post-content ast-col-md-12">
										...
										<header class="entry-header">
											...
											<div class="entry-meta">
												<span> <i>last updated：</i> <fmt:formatDate
														value="${dateObject}" pattern="yyyy-MM-dd HH:mm:ss" />  
												</span>
											</div>
										</header>
										<!-- .entry-header -->
				...
				<div itemtype="https://schema.org/WPSideBar" itemscope="itemscope"
					...
					<div class="sidebar-main">
						...
						<aside id="recent-comments-2"
							class="widget widget_recent_comments">
							<h2 class="widget-title">其他婚恋相关检索</h2>
							<ul id="recentcomments"></ul>
						</aside>
						<aside id="meta-2" class="widget widget_meta">
							<h2 class="widget-title">问题列表(不断添加中)</h2>
							<ul>
								<li><a href="#">西安的你，择偶条件是什么</a></li>
								<li><a href="#">北京的你，择偶条件是什么</a></li>
								<li><a href="#">上海的你，择偶条件是什么</a></li>
								<li><a href="#">广州的你，择偶条件是什么</a></li>
								<li><a href="#">成都的你，择偶条件是什么</a></li>

							</ul>
						</aside>
						
						<aside id="meta-2" class="widget widget_meta">
							<h2 class="widget-title">目前存在的bug</h2>
							<ul>
								<li><a href="#">待收集</a></li>
							</ul>
						</aside>
					...
					<div class="ast-container">
						<div class="ast-small-footer-wrap">
							<div class="ast-small-footer-section ast-small-footer-section-1">
								Copyright © 2019 <span class="ast-footer-site-title">BECTO</span>
								| Powered by <a href="https://wpastra.com/">Astra</a> |
								陕ICP备19002498
							</div>
